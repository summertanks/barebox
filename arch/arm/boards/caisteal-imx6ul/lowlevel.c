...
extern char __dtb_imx6ul_caisteal_start[];

static noinline void caisteal_imx6ul(void)
{
	imx6ul_barebox_entry(__dtb_imx6ul_caisteal_start);
}

ENTRY_FUNCTION(start_caisteal_imx6ul, r0, r1, r2)
{
